    ...
    <>
      ...
      <main>
        <section className="bg-slate-50 py-12">
          <Container>
            <h1 className="text-4xl font-bold text-slate-900 mb-4">Our Vendors</h1>
            <p className="text-slate-600 max-w-3xl">
              We work with industry-leading vendors to deliver comprehensive data center
        ...
        <Container>
          <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            {vendors.map((vendor) => (
              ...
              >
                <h2 className="text-xl font-semibold text-slate-900 mb-2">{vendor.name}</h2>
                <p className="text-slate-600">{vendor.summary}</p>
              </Link>
            ))}
          </div>
        </Container>
